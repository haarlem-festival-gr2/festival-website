    ...
    <form
        ...
        <div class="flex flex-col gap-2">
            ...
            <label for="username" class="flex flex-col">
                Username
                <input id="username" type="string" name="username" class="border border-black rounded p-2" required />
            </label>
            <label for="name" class="flex flex-col">
                Name
                <input id="name" type="string" name="name" class="border border-black rounded p-2" required />
            </label>
