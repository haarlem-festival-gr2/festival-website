...
<!-- description -->
<div class="p-8 relative" style="background-color: #fdbef5; text-align: center;">
    <p class="mb-4" id="festivalText">Haarlem Jazz, a cornerstone of our city's festival calendar, comes alive as we revive past echoes at Patronaat. Join us in this musical journey, where renowned bands recreate the festival's essence. Feel the vibrant rhythms and melodies on Sunday at Grote Markt, where bands perform for all, free of charge!</p>
    <button onclick="speakText()" style="position: absolute; bottom: 10px; right: 10px; background: none; border: none; font-size: 24px;">
        🔊
    </button>
</div>
