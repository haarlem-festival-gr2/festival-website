    ...
    <section>
        ...
        <div class="grid grid-cols-10 mt-8 text-center text-3xl relative">
            ...
            <div class="col-span-3 p-2 row-span-2">
                <img src="img/yummy/RatatouileFood1.png" alt="A fancy dish being displayed on a fancy plate."
                    class="mt-8 shadow-lg rounded-3xl" />
            </div>
            <div class="col-span-4 p-2 row-span-2">
                <img src="img/yummy/RatatouileFood2.png" alt="Food on a grill looking tasty."
