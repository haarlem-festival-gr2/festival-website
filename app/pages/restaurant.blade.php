...
<body class="font-open-sans bg-amber-100 text-black">
    <div class="relative">
        <img src="img/yummy/RatatouileHeader.png" alt="The Grote Markt which has people walking and restaurant stalls."
            class="w-full">
    </div>
    ...
    <div class="grid grid-cols-10 mt-8 text-center text-3xl relative">
        ...
        <div class = "col-span-4 p-12 row-span-1 flex justify-end">
            ...
            <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #FFD43B;"></i> <!--Yellow Star Icon-->
            <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #FFD43B;"></i> <!--Yellow Star Icon-->
            <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #98A6A9;"></i> <!--White Star Icon-->
        </div>

        <!-- Restaurant Image -->
        <div class="col-span-3 p-2 row-span-2">
            <img src="img/yummy/RatatouileFood1.png" alt="A fancy dish being displayed on a fancy plate." class="mt-8 shadow-lg rounded-3xl">
        </div>
        <div class="col-span-4 p-2 row-span-2">
            <img src="img/yummy/RatatouileFood2.png" alt="Food on a grill looking tasty." class="shadow-lg rounded-3xl">
        </div>
        <div class="col-span-3 p-2 row-span-2">
            <img src="img/yummy/RatatouileFood3.png" alt="Fancy looking dish." class="mt-8 shadow-lg rounded-3xl">
        </div>
        ...
        <div class="col-span-5 p-2 row-span-4">
            <div class="grid grid-cols-4 bg-amber-400 h-full rounded-2xl shadow-lg">
                ...
                <div class="col-span-1 row-spawn-2 mt-12">
                    <i class="fa-solid fa-regular fa-user-group fa-2xl" style="color: #c026d3;"></i> <!--Cutlery Icon-->
        ...
        <div class="col-span-5 p-2 row-span-4">
            <div class="grid grid-cols-4 bg-amber-400 rounded-2xl shadow-lg p-2">
                <div class="col-span-2 row-spawn-2 flex justify-center items-center">
                    <i class="fa-sharp fa-regular fa-user fa-2xl" style="color: #c026d3;"></i> <!--3 Person Icon-->
                    <div class="bg-pink-500 p-2 shadow-lg rounded-3xl flex justify-center items-center ml-4">
                        <i class="fa-solid fa-euro-sign fa-2xl" style="color: #ffffff;"></i> <!--Euro Idockcon-->
                        <h1 class="p-6 text-white"><b>45.00</b></h1>
                    </div>
                </div>
                <div class="col-span-2 row-spawn-4">
                    <i class="fa-solid fa-regular fa-utensils fa-2xl mt-8" style="color: #c026d3;"></i> <!--Cutlery Icon-->
                    <h1 class="mt-2"><b>French</b></h1>
                    <h1><b>Fish & Seafood</b></h1>
                    <h1><b>European</b></h1>
                </div>
                <div class="col-span-2 row-spawn-2 flex justify-center items-center">
                    <i class="fa-solid fa-regular fa-baby fa-2xl" style="color: #c026d3;"></i> <!--Baby Icon-->
                    <div class="bg-pink-500 p-2 shadow-lg rounded-3xl flex justify-center items-center ml-4">
                        <i class="fa-solid fa-euro-sign fa-2xl" style="color: #ffffff;"></i> <!--Euro Icon-->
