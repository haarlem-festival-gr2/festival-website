...
<div class="flex h-screen">
    ...
    <section class="w-4/5 p-4 overflow-y-auto" style="max-height: calc(100vh - 50px);">
        <div class="max-w-lg mx-auto bg-white p-8 rounded-md shadow-md">
            <h1 class="text-xl font-bold mb-4 flex justify-center">Create Performance</h1>
            <form hx-post="/performances/createPerformance" hx-target="#error">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="time" id="start_time" name="start_time" required class="w-full border rounded-md px-3 py-2">
                </div>
                <div class="mb-4">
                    <label for="end_time" class="block mb-2">End Time*:</label>
                    <input type="time" id="end_time" name="end_time" required class="w-full border rounded-md px-3 py-2">
                </div>
                <div class="mb-4">
                    <label for="price" class="block mb-2">Price, €*:</label>
                    <input type="number" id="price" name="price" step="0.1" required class="w-full border rounded-md px-3 py-2">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="details" name="details" class="w-full border rounded-md px-3 py-2"></textarea>
                </div>
                <div id="error"></div>
