...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css" integrity="sha512-Q85xgzayNwtT9vIkzYuhCe9zgbjXJtexzAUcSUcvz6SaNEcYGTl4PvaYT2RtN1dfqZUhz7tCOBbXJkWNHNlxuA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
<!-- <script>
    function speakText() {
...
<div class="relative w-full h-screen bg-no-repeat bg-cover" style="background-image: url('/img/history/walky.png');">
    ...
    <a href="#next-section" onclick="scrollToNextSection()" class="bg-yellow-400 text-gray-800 py-2 px-4 border border-gray-800 rounded text-lg font-bold no-underline">Discover Haarlem</a>
</div>
    ...
    <section class="my-12 mx-4 md:mx-0">
        <div class="flex flex-wrap justify-around">
            <div class="text-center p-4">
                <div class="w-24 h-24 flex items-center justify-center rounded-full text-white text-4xl mb-4 bg-yellow-400"><i class="fas fa-map-marker-alt"></i></div>
                <p>Meeting point: <strong>Church of St. Bavo</strong></p>
            </div>
            <div class="text-center p-4">
                <div class="w-24 h-24 flex items-center justify-center rounded-full text-white text-4xl mb-4 bg-yellow-400"><i class="fas fa-calendar-alt"></i></div>
                <p>July: <strong>26th, 27th, 28th, 29th</strong></p>
            </div>
            <div class="text-center p-4">
                <div class="w-24 h-24 flex items-center justify-center rounded-full text-white text-4xl mb-4 bg-yellow-400"><i class="fas fa-clock"></i></div>
                <p>Time: <strong>10:00, 13:00, 16:00</strong></p>
            </div>
            <div class="text-center p-4">
                <div class="w-24 h-24 flex items-center justify-center rounded-full text-white text-4xl mb-4 bg-yellow-400"><i class="fas fa-euro-sign"></i></div>
                <p>Individual price: <strong>17.50 euro</strong>, family price: <strong>60 euro</strong></p>
            </div>
            <div class="text-center p-4">
                <div class="w-24 h-24 flex items-center justify-center rounded-full text-white text-4xl mb-4 bg-yellow-400"><i class="fas fa-users"></i></div>
...
<section class="my-12 text-center">
  ...
  <div style="background-color: #B92090;" class="p-2 rounded-t mb-0"> 
      ...
      </div><div style="background-color: #B92090;" class="p-2 rounded-t mb-0"> 
...
<!-- City Walk -->
  ...
  <div class="p-4 flex-1">
    ...
    <h2 class="text-2xl bg-pink-200 text-black font-semibold py-4 px-10 inline-block rounded mb-4">City Walk</h2>
    <p class="text-lg font-medium text-black mb-4">Embark on a captivating journey through Haarlem's with our guided tours available in English, Dutch and Chinese at 10:00, 13:00, and 16:00. These tours will take you on a fascinating exploration of various sites across Haarlem, offering insights into its rich history and culture.</p>
    <p class="text-gray-800 mb-6">With limited spots (12 per tour), ensure your place by reserving your tickets in advance. The duration of this walking tour will be approximately 2.5 hours, including a 15-minute break with refreshments.</p>
    <!-- Larger button below the text -->
    <div class="text-center md:text-left">
      <button class="text-lg bg-pink-700 hover:bg-pink-800 text-white font-bold py-3 px-6 rounded-full transition-colors duration-200">
        Buy ticket
      </button>
    </div>
  </div>
...
<section class="my-12 text-center">
  <div class="flex justify-center items-center space-x-8"> 
    <!-- Individual ticket -->
    <div class="bg-yellow-400 w-96 md:w-108 h-44 rounded-tl-3xl rounded-tr-lg rounded-bl-lg rounded-br-3xl relative overflow-hidden shadow-lg">
    ...
    <!-- Family ticket -->
    <div class="bg-yellow-400 w-96 md:w-108 h-44 rounded-tl-lg rounded-tr-3xl rounded-bl-3xl rounded-br-lg relative overflow-hidden shadow-lg">
      <div class="absolute inset-0 px-4 py-4 flex flex-col justify-between">
...
<div class="bg-grey p-6">
  ...
  <div class="bg-pink-200 p-4 rounded-tl-lg rounded-tr-3xl rounded-bl-3xl rounded-br-lg relative overflow-hidden shadow-lg">
...
<!-- Audio Guide -->
 <section style="background-color: #FCC040;" class="p-6 text-center">
  ...
  <div class="flex flex-col md:flex-row justify-center items-stretch md:space-x-4">
    <!-- Form Section -->
<div style="background-color: #FDC9EF;" class="flex-grow p-4 rounded-lg md:basis-1/2 max-w-2xl mx-auto mb-4 md:mb-0">
  <form action="#" method="POST" class="flex flex-col justify-between h-full">
    <div>
      ...
      <input type="text" id="name" name="name" placeholder="Tom Johnson" class="mt-1 p-2 w-full rounded-md border-gray-300 shadow-sm mb-4">
    </div>
    <div>
