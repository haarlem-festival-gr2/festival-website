...
<div class="relative w-full h-screen bg-no-repeat bg-cover" style="background-image: url('/img/history/walky.png');">
    ...
    <a href="#" onclick="scrollToNextSection()" class="bg-yellow-400 text-gray-800 py-2 px-4 border border-gray-800 rounded text-lg font-bold no-underline">Discover Haarlem</a>
</div>
