...
<div class="container mx-auto my-10 p-8 bg-gray-100 bg-opacity-25 rounded-lg shadow-xl">
    ...
    <div class="md:flex md:justify-center">
        <div class="md:w-1/2 bg-yellow-400 p-4 rounded-lg text-center">
            <p class="text-2xl mb-2">Thanks for your purchase!</p>
            <p class="text-lg mt-4 mb-6">Your tickets and invoice have been sent to your email.</p>
        </div>
    </div>
