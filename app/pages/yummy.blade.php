  ...
  <body class="font-open-sans bg-amber-100 text-black">
    ...
    <section>
      <div class="grid grid-cols-10 mt-36 mx-4 text-center text-3xl relative">
        <div
          class="col-span-3 p-2 row-span-2 bg-yellow-300 rounded-2xl shadow-lg relative"
        >
          <p>
        ...
        <div class="col-span-3 p-4 row-span-2">
          <img
            src="img/yummy/yummyInfo1.png"
            alt="Food being grilled and looking tasty."
            class="w-full shadow-lg rounded-3xl"
          />
        </div>
        <div class="col-span-1 p-4 row-span-6"></div>
        <div
          class="bg-yellow-300 col-span-3 p-4 rounded-2xl shadow-lg relative"
        >
          <p>
        ...
        <div class="col-span-3 p-4 row-span-2">
          <img
            src="img/yummy/yummyInfo4.png"
            alt="Big wooden plate with sushi and other tasty food."
            class="w-full shadow-lg rounded-3xl"
          />
        </div>
        <div class="col-span-3 p-4 row-span-2">
          <img
            src="img/yummy/yummyInfo2.png"
            alt="Food on grey clay plate."
            class="w-full shadow-lg rounded-3xl"
          />
        </div>
        <div class="col-span-3 p-4 row-span-2">
          <img
            src="img/yummy/yummyInfo3.png"
            alt="Food on black clay plate, looking good!"
            class="w-full shadow-lg rounded-3xl"
          />
        </div>
        <div
        ...
        <div
          class="bg-yellow-300 col-span-6 p-4 rounded-2xl shadow-lg relative"
        >
          <p>
      ...
      <div>
        ...
        <div class="bg-fuchsia-600 mt-16">
          <div class="grid grid-cols-10 mt-24 text-center text-3xl relative">
            ...
            <div class="col-span-6 p-2 row-span-4">
              <img
                src="img/yummy/yummyHomeRatatouile.png"
            ...
            <div class="col-span-4 p-2 row-span-4">
              <div
                class="grid grid-cols-4 bg-slate-50 h-full p-6 rounded-2xl shadow-lg"
              >
                ...
                <div class="col-span-2 row-spawn-2 mt-8">
                  <i
                    class="fa-solid fa-regular fa-utensils fa-2xl"
                    style="color: #c026d3"
                  ></i>
                  <!--Cutlery Icon-->
        ...
        <div class="bg-pink-400 h-32">
          <div class="flex justify-center items-center">
            <a
              href="/restaurant"
              class="button rounded-full text-5xl mr-16 mt-8"
              >Make Reservation!</a
            >
            <!-- Replace with Reservation -->
            <a
              href="/restaurant"
              class="button rounded-full text-5xl ml-16 mt-8"
              >More Information</a
            >
          </div>
        </div>
        ...
        <div class="bg-fuchsia-600 mt-16">
          <div class="grid grid-cols-10 mt-24 text-center text-3xl relative">
            ...
            <div class="col-span-6 p-2 row-span-4">
              <img
                src="img/yummy/yummyHomeCaféDeRoemer.png"
                alt="A view of the inside of the Ratatouile restaurant, showing multiple seats, fancy lightning and some paintings."
                class="w-full shadow-lg rounded-3xl"
              />
            </div>
