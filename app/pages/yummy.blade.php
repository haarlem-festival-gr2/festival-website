...
<body class="font-open-sans bg-amber-100 text-black">
    ...
    <div class="relative mt-8">
        ...
        <div class="bg-pink-400 h-16 w-4/6 absolute left-0 top-1">
            <h1 class="text-4xl p-2 font-bold text-center">Embark on a Culinary journey in Haarlem!</h1>
        </div>
    </div>
    ...
    <section>
        <div class="grid grid-cols-10 mt-36 mx-4 text-center text-3xl relative">
            <div class="col-span-3 p-2 row-span-2 bg-yellow-300 rounded-2xl shadow-lg relative">
                <p>Come and explore the different <b>sessions</b> at each restaurant! Think tasty appetisers, hearty
                    mains and sweet treats for dessert. <br><br>You can <b>reserve</b> a spot and treat your taste buds
                    to a special menu at each place.</p>
            </div>
            ...
            <div class="bg-yellow-300 col-span-3 p-4 rounded-2xl shadow-lg relative">
                <p>This is not just about food - It's about diving into Haarlem's <b>unique</b> food culture.</p>
            </div>
            <div class="col-span-3 p-4 row-span-2">
            ...
            <div class="col-span-3 p-4 row-span-2">
                <img src="img/yummy/yummyInfo2.png" alt="Food on grey clay plate." class="w-full shadow-lg rounded-3xl">
            </div>
            <div class="col-span-3 p-4 row-span-2">
            ...
            <div class="bg-yellow-300 col-span-3 p-4 rounded-2xl shadow-lg relative">
                <p><b>Meet the local chefs</b>, find out what inspires them, and enjoy the <b>unique flavours</b> that
                    make
                    Haarlem's food
                    scene so special.</p>
            </div>
            <div class="bg-yellow-300 col-span-6 p-4 rounded-2xl shadow-lg relative">
                <p>Whether you're a food lover, a local looking for something new, or a visitor wanting to experience
                    Haarlem's taste, the <b>Yummy Food Festival is where it's at</b>. Bring your appetite and let's make
                    some
                    <b>delicious</b> memories together!
                </p>
            </div>
    ...
    <div class="relative mt-16">
        <div class="bg-pink-400 h-24">
            <h1 class="text-4xl p-6 font-bold text-center">Participating Restaurants!</h1>
        </div>
    </div>
        ...
        <div>
            ...
            <div class="bg-fuchsia-600 mt-16">
                <div class="grid grid-cols-10 mt-24 text-center text-3xl relative">
                    ...
                    <div class = "col-span-5 p-12 row-span-1 flex justify-end">
                        <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #FFD43B;"></i> <!--Yellow Star Icon-->
                        <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #FFD43B;"></i> <!--Yellow Star Icon-->
                        <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #FFD43B;"></i> <!--Yellow Star Icon-->
                        <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #FFD43B;"></i> <!--Yellow Star Icon-->
                        <i class="fa-sharp fa-solid fa-star fa-2xl" style="color: #ffffff;"></i> <!--White Star Icon-->
                    </div>
                    <!-- Restaurant Image -->
                    <div class="col-span-6 p-2 row-span-4">
                        <img src="img/yummy/yummyHomeRatatouile.png" alt="A view of the inside of the Ratatouile restaurant, showing multiple seats, fancy lightning and some paintings." class="w-full shadow-lg rounded-3xl">
                    </div>
                    ...
                    <div class="col-span-4 p-2 row-span-4">
                        <div class="grid grid-cols-4 bg-slate-50 h-full p-6 rounded-2xl shadow-lg">
                            <div class="col-span-2 row-spawn-2 mt-8">
                                <i class="fa-sharp fa-regular fa-3 fa-2xl" style="color: #c026d3;"></i> <!--3 Icon-->
                                <h1 class="mt-6">Sessions</h1>
                                <h1><b><b>3 a day</b></b></h1>
                            </div>
                            <div class="col-span-2 row-spawn-2 mt-8">
                                <i class="fa-sharp fa-regular fa-clock fa-2xl" style="color: #c026d3;"></i> <!--Clock Icon-->
                                <h1 class="mt-6">Start Time</h1>
                                <h1>session starts</h1>
                                <h1><b>17:00</b></h1>
                            </div>
                            <div class="col-span-2 row-spawn-2 mt-8">
                                <i class="fa-sharp fa-regular fa-hourglass-half fa-2xl" style="color: #c026d3;"></i> <!--Hourglass Icon--> 
                                <h1 class="mt-6">Session Time</h1>
                                <h1><b>2 hours</b></h1>
                            </div>
                            <div class="col-span-2 row-spawn-2 mt-8">
                                <i class="fa-solid fa-regular fa-utensils fa-2xl" style="color: #c026d3;"></i> <!--Cutlery Icon-->
            ...
            <div class="bg-pink-400 h-32">
                <div class="flex justify-center items-center">
                    <a href="/restaurant" class="button rounded-full text-5xl mr-16 mt-8">Make Reservation!</a> <!-- Replace with Reservation -->
            ...
            <div class="bg-fuchsia-600 mt-16">
                <div class="grid grid-cols-10 mt-24 text-center text-3xl relative">
                    ...
                    <div class="col-span-5 p-2 row-span-1">
                        <div class="bg-amber-400">
                            <h1 class="text-7xl p-2 font-bold text-center">Café de Roemer</h1>
                        </div>
                    </div>
                    <!-- Star Rating -->
                    <div class = "col-span-5 p-12 row-span-1 flex justify-end">
                    ...
                    <!-- Restaurant Image -->
                    <div class="col-span-6 p-2 row-span-4">
                        <img src="img/yummy/yummyHomeCaféDeRoemer.png" alt="A view of the inside of the Ratatouile restaurant, showing multiple seats, fancy lightning and some paintings." class="w-full shadow-lg rounded-3xl">
                    </div>
                </div>
            </div>
            <!-- Restaurant Location -->
